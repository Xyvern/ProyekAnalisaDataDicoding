...
# Notebook code
dfOrderItems = pd.read_csv("./Dataset/order_items_dataset.csv", delimiter=",")
dfOrderReviews = pd.read_csv("./Dataset/order_reviews_dataset.csv", delimiter=",")
dfOrders = pd.read_csv("./Dataset/orders_dataset.csv", delimiter=",")
dfProducts = pd.read_csv("./Dataset/products_dataset.csv", delimiter=",")
